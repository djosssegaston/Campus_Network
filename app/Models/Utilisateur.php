...
class Utilisateur extends AuthenticatableUser implements MustVerifyEmail
{
    ...
    // Relations : paramètres de confidentialité
    public function privacySettings()
    {
        return $this->hasOne(UserPrivacySetting::class, 'utilisateur_id');
    }

    // Obtenir ou créer les paramètres de confidentialité
    public function getOrCreatePrivacySettings()
    {
    ...
    // Relations : exports de données
    public function dataExports()
    {
        return $this->hasMany(DataExport::class, 'utilisateur_id');
    }
    ...
    // Relations : partages de publications
    public function partages(): HasMany
    {
        return $this->hasMany(Partage::class, 'utilisateur_id');
    }
    ...
    // Relations : messages de groupe
    public function groupeMessages(): HasMany
    {
        return $this->hasMany(GroupeMessage::class, 'utilisateur_id');
    }
    ...
    /**
     * Vérifier si l'utilisateur est modérateur global
     */
    public function estModerateurGlobal(): bool
    {
        if (!$this->role_id) {
            return false;
        }
    ...
    /**
     * Vérifier si l'utilisateur a une des permissions données
     */
