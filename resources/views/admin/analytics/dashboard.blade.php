...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-3xl font-bold text-gray-900">{{ $stats['total_publications'] }}</p>
        </div>
        
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-gray-500 text-sm font-semibold uppercase">Groupes</h3>
            <p class="text-3xl font-bold text-gray-900">{{ $stats['total_groups'] }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('analytics.users') }}" class="block p-4 border rounded-lg hover:bg-blue-50 transition">
                <h3 class="font-bold text-lg mb-2">👥 Utilisateurs</h3>
                <p class="text-gray-600">Statistiques détaillées des utilisateurs</p>
            </a>
            
            <a href="{{ route('analytics.publications') }}" class="block p-4 border rounded-lg hover:bg-blue-50 transition">
                <h3 class="font-bold text-lg mb-2">📝 Publications</h3>
                <p class="text-gray-600">Analyse des publications</p>
            </a>
            
            <a href="{{ route('analytics.groups') }}" class="block p-4 border rounded-lg hover:bg-blue-50 transition">
                <h3 class="font-bold text-lg mb-2">👫 Groupes</h3>
                <p class="text-gray-600">Statistiques des groupes</p>
            </a>
            
            <a href="{{ route('analytics.engagement') }}" class="block p-4 border rounded-lg hover:bg-blue-50 transition">
                <h3 class="font-bold text-lg mb-2">💬 Engagement</h3>
                <p class="text-gray-600">Analyse d'engagement</p>
            </a>
            
            <a href="{{ route('analytics.export') }}" class="block p-4 border rounded-lg hover:bg-blue-50 transition">
