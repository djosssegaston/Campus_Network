    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('dashboard') }}" class="hover:text-white transition">Tableau de bord</a></li>
                    <li><a href="{{ route('feed.index') }}" class="hover:text-white transition">Fil d'actualités</a></li>
                    <li><a href="{{ route('groupes.index') }}" class="hover:text-white transition">Groupes</a></li>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-sm text-gray-400">
                &copy; {{ date('Y') }} Campus Network. Tous droits réservés.
            </p>
