...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <form method="POST" action="<?php echo e(route('settings.update')); ?>">
            ...
            <div class="mb-6">
                ...
                <textarea name="app_description" rows="4" class="w-full px-4 py-2 border rounded-lg"><?php echo e($settings['app_description'] ?? ''); ?></textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="max_upload_size" min="1" max="1000"
                       class="w-full px-4 py-2 border rounded-lg"
                       value="<?php echo e($settings['max_upload_size'] ?? '100'); ?>">
            </div>
            
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="maintenance_mode" value="1" 
                           <?php echo e(($settings['maintenance_mode'] ?? false) ? 'checked' : ''); ?> class="rounded">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="allow_user_registration" value="1" 
                           <?php echo e(($settings['allow_user_registration'] ?? true) ? 'checked' : ''); ?> class="rounded">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="allow_group_creation" value="1" 
                           <?php echo e(($settings['allow_group_creation'] ?? true) ? 'checked' : ''); ?> class="rounded">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="moderation_enabled" value="1" 
                           <?php echo e(($settings['moderation_enabled'] ?? true) ? 'checked' : ''); ?> class="rounded">
    ...
    <div class="flex gap-4">
        <a href="<?php echo e(route('settings.logs')); ?>" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600">
            Voir les Logs
        </a>
        <form method="POST" action="<?php echo e(route('settings.maintenance')); ?>" class="inline">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\admin\settings\index.blade.php ENDPATH**/ ?>