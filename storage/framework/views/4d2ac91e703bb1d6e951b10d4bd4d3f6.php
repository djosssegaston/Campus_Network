...
<?php $__env->startSection('title', 'Paramètres de Confidentialité'); ?>
...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="max-w-2xl mx-auto">
        ...
        <!-- Formulaire -->
        <form method="POST" action="<?php echo e(route('privacy-settings.update')); ?>" class="space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            value="public"
                            <?php echo e($privacySettings->profil_visibilite === 'public' ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            name="profil_visibilite" 
                            value="amis"
                            <?php echo e($privacySettings->profil_visibilite === 'amis' ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            name="profil_visibilite" 
                            value="prive"
                            <?php echo e($privacySettings->profil_visibilite === 'prive' ? 'checked' : ''); ?>
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input 
                                    ...
                                    value="tous"
                                    <?php echo e($privacySettings->messages_acceptes === 'tous' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="messages_acceptes" 
                                    value="amis"
                                    <?php echo e($privacySettings->messages_acceptes === 'amis' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="messages_acceptes" 
                                    value="personne"
                                    <?php echo e($privacySettings->messages_acceptes === 'personne' ? 'checked' : ''); ?>
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input 
                                    ...
                                    value="public"
                                    <?php echo e($privacySettings->publications_lisibles === 'public' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="publications_lisibles" 
                                    value="amis"
                                    <?php echo e($privacySettings->publications_lisibles === 'amis' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="publications_lisibles" 
                                    value="prive"
                                    <?php echo e($privacySettings->publications_lisibles === 'prive' ? 'checked' : ''); ?>
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input 
                                    ...
                                    value="tous"
                                    <?php echo e($privacySettings->commentaires_acceptes === 'tous' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="commentaires_acceptes" 
                                    value="amis"
                                    <?php echo e($privacySettings->commentaires_acceptes === 'amis' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center">
                                <input 
                                    ...
                                    name="commentaires_acceptes" 
                                    value="personne"
                                    <?php echo e($privacySettings->commentaires_acceptes === 'personne' ? 'checked' : ''); ?>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->afficher_contacts ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->afficher_groupes ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->afficher_activite ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->mentions_autorisees ? 'checked' : ''); ?>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->notifier_requetes_contact ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->notifier_commentaires ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            <?php echo e($privacySettings->notifier_reactions ? 'checked' : ''); ?>
                ...
                <div class="space-y-3">
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            value="public"
                            <?php echo e($privacySettings->groupes_visibles === 'public' ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                        <input 
                            ...
                            name="groupes_visibles" 
                            value="prive"
                            <?php echo e($privacySettings->groupes_visibles === 'prive' ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\profile\privacy-settings.blade.php ENDPATH**/ ?>