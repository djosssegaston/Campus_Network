...
<div class="p-8 bg-gray-50 min-h-screen">
    ...
    <?php if(in_array($roleSlug, ['administrateur', 'super_admin'])): ?>
        <!-- Header Admin -->
        <div class="mb-8">
    ...
    <?php else: ?>
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="inline-block mt-6 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\admin\index.blade.php ENDPATH**/ ?>