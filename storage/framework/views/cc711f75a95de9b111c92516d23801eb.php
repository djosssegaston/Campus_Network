...
<?php $__env->startSection('title', 'Réinitialiser le Mot de Passe - Campus Network'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-card','data' => ['title' => 'Réinitialiser votre mot de passe','subtitle' => 'Créez un nouveau mot de passe sécurisé','gradientFrom' => 'from-blue-600','gradientTo' => 'to-blue-700','footer' => true,'footerText' => 'Vous vous souvenez? ','footerLink' => ''.e(route('login')).'','footerLinkText' => 'Se connecter']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Réinitialiser votre mot de passe','subtitle' => 'Créez un nouveau mot de passe sécurisé','gradientFrom' => 'from-blue-600','gradientTo' => 'to-blue-700','footer' => true,'footerText' => 'Vous vous souvenez? ','footerLink' => ''.e(route('login')).'','footerLinkText' => 'Se connecter']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-input','data' => ['name' => 'email','type' => 'email','label' => 'Adresse Email','placeholder' => 'vous@example.com','value' => old('email', $request->email),'required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'email','type' => 'email','label' => 'Adresse Email','placeholder' => 'vous@example.com','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email', $request->email)),'required' => true,'autofocus' => true]); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginal93a7e4fbb8709cb7edbcf616ab99cd14 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal93a7e4fbb8709cb7edbcf616ab99cd14 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-input','data' => ['name' => 'password','type' => 'password','label' => 'Nouveau Mot de Passe (minimum 8 caractères)','placeholder' => '••••••••','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'password','type' => 'password','label' => 'Nouveau Mot de Passe (minimum 8 caractères)','placeholder' => '••••••••','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal93a7e4fbb8709cb7edbcf616ab99cd14)): ?>
<?php $attributes = $__attributesOriginal93a7e4fbb8709cb7edbcf616ab99cd14; ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>