        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-1">
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php if(request()->routeIs('dashboard')): ?> bg-blue-100 text-blue-700 <?php else: ?> text-gray-600 hover:text-gray-900 hover:bg-gray-100 <?php endif; ?>">
                ...
                <a href="<?php echo e(route('feed.index')); ?>" 
                   class="px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php if(request()->routeIs('feed')): ?> bg-blue-100 text-blue-700 <?php else: ?> text-gray-600 hover:text-gray-900 hover:bg-gray-100 <?php endif; ?>">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                    </svg>
                    Fil d'actualités
                ...
                <a href="<?php echo e(route('groupes.index')); ?>" 
                   class="px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php if(request()->routeIs('groupes.*')): ?> bg-blue-100 text-blue-700 <?php else: ?> text-gray-600 hover:text-gray-900 hover:bg-gray-100 <?php endif; ?>">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('messages.index')); ?>" 
                   class="px-3 py-2 rounded-lg text-sm font-medium transition-colors relative <?php if(request()->routeIs('messages.*')): ?> bg-blue-100 text-blue-700 <?php else: ?> text-gray-600 hover:text-gray-900 hover:bg-gray-100 <?php endif; ?>">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('search.index')); ?>" 
                   class="px-3 py-2 rounded-lg text-sm font-medium transition-colors <?php if(request()->routeIs('search.*')): ?> bg-blue-100 text-blue-700 <?php else: ?> text-gray-600 hover:text-gray-900 hover:bg-gray-100 <?php endif; ?>">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative group">
                    <button class="flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition">
                        <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=<?php echo e(auth()->user()->id); ?>" 
                             alt="<?php echo e(auth()->user()->nom); ?>" 
                    ...
                    <div class="hidden group-hover:block absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg overflow-hidden z-50">
                        <div class="px-4 py-3 border-b border-gray-200">
                            <p class="text-sm font-medium text-gray-900"><?php echo e(auth()->user()->nom); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e(auth()->user()->email); ?></p>
                        </div>
                        
                        <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition">
                            <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\components\navigation.blade.php ENDPATH**/ ?>