...
<?php $__env->startSection('title', 'Créer une Publication'); ?>
...
<div class="p-8 max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form action="<?php echo e(route('publications.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            
            <div class="mb-4">
                <label for="contenu" class="block text-sm font-medium text-gray-700 mb-2">Contenu</label>
                <textarea id="contenu" name="contenu" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['contenu'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Écrivez votre publication..." required><?php echo e(old('contenu')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select id="visibilite" name="visibilite" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['visibilite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    <option value="public" <?php echo e(old('visibilite') == 'public' ? 'selected' : ''); ?>>🌍 Publique</option>
                    <option value="amis" <?php echo e(old('visibilite') == 'amis' ? 'selected' : ''); ?>>👥 Amis seulement</option>
                    <option value="prive" <?php echo e(old('visibilite') == 'prive' ? 'selected' : ''); ?>>🔒 Privé</option>
                </select>
                <?php $__errorArgs = ['visibilite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('feed.index')); ?>" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition font-medium">
                    Annuler
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\publications\create.blade.php ENDPATH**/ ?>