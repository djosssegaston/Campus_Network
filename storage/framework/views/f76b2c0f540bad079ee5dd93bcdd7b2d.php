...
<?php $__env->startSection('title', 'Mot de passe oublié - Campus Network'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-card','data' => ['title' => 'Réinitialiser votre mot de passe','subtitle' => 'Entrez votre adresse email pour recevoir un lien de réinitialisation','gradientFrom' => 'from-blue-600','gradientTo' => 'to-blue-700','footer' => true,'footerText' => 'Vous vous souvenez? ','footerLink' => ''.e(route('login')).'','footerLinkText' => 'Se connecter']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Réinitialiser votre mot de passe','subtitle' => 'Entrez votre adresse email pour recevoir un lien de réinitialisation','gradientFrom' => 'from-blue-600','gradientTo' => 'to-blue-700','footer' => true,'footerText' => 'Vous vous souvenez? ','footerLink' => ''.e(route('login')).'','footerLinkText' => 'Se connecter']); ?>
    <?php if(session('status')): ?>
        <?php if (isset($component)) { $__componentOriginal5194778a3a7b899dcee5619d0610f5cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['type' => 'success','title' => 'Email envoyé']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','title' => 'Email envoyé']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-input','data' => ['name' => 'email','type' => 'email','label' => 'Adresse Email','placeholder' => 'vous@example.com','required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'email','type' => 'email','label' => 'Adresse Email','placeholder' => 'vous@example.com','required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Campus_Network\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>